...
-- See pollution-condenser-building.lua for why this shrinks chemical-plant's
...
-- See pollution-condenser-building.lua for why this strips chemical-plant's
...
-- pollution-condenser-building.lua for why the connection position is
...
-- Fully replaced, not merged, for the same reason as condenser. Tier-1 outflow
